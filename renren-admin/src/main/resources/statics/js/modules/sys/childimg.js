$(function () {
    ...
    new AjaxUpload('#upload', {
        ...
        onComplete : function(file, r){
            if(r.code == 0){
                vm.$set(vm.childImg, 'imageUrl', r.url);
            }else{
                alert(r.msg);
            }
        },
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.childImg.id == null ? "sys/childimg/save" : "sys/childimg/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
                contentType: "application/json",
			    data: JSON.stringify(vm.childImg),
			    success: function(r){
			    	if(r.code === 0){
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "sys/childimg/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "sys/childimg/info/"+id, function(r){
                vm.childImg = r.childImg;
            });
		},
